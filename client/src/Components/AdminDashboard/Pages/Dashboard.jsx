      ...
      <Container sx={{ display: 'flex', flexDirection: 'column', padding: '30px', background: 'white', margin: '10px', borderRadius: '5px' }}>
        ...
        <Box sx={{ display: 'flex', flexDirection: 'row', flexWrap: 'wrap' }}>
          <Alert severity="info" sx={{ width: '100%', display: 'flex', justifyContent: 'center' }}>
            ...
            Here you can edit, modify, view the statistics for the — <strong>entire site!</strong>
          </Alert>
        </Box>
        <Typography variant='h5' sx={{ my: 1 }}>What do you want to do?</Typography>
        <Box sx={{ display: 'flex', flexDirection: 'row', justifyContent: 'center', flexWrap: 'wrap', padding: '10px' }}>
          ...
          <Card sx={{ margin: '10px' }} onClick={() => reducer("SET_PAGE", 'estadisticas')}>
            ...
            <CardActions>
              <Button size="small" onClick={() => reducer("SET_PAGE", 'estadisticas')}>View Panel</Button>
            </CardActions>
          </Card>
        </Box>
      </Container>
